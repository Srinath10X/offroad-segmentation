...
![Comparison 2](./.github/assets/sample.png)
**Sample Prediction 2 (AdamW Optimizer):**
![Comparison 2](.github/assets/optimized_class.png)
...
#### Metrics 2 using (AdamW)
![Metrics Chart](.github/assets/optimized_bar.png)
